...
module Orocos
    ...
    class << self
        ...
        def registry
            master_typekit.registry
        end

        # The project that represents everything that got loaded so far
        attr_reader :master_project

        # The typekit that represents everything that got loaded so far
        def master_typekit
            master_project.typekit
        end
