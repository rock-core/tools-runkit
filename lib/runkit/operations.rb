...
module Runkit
    ...
    class Operation
        ...
        attr_reader :runkit_return_typenames
        ...
        attr_reader :runkit_arguments_typenames
        # The typelib types for the arguments. This is an array of subclasses of
        # Typelib::Type, with each element being the type of the corresponding
        ...
        def initialize(task, name, return_spec, arguments_spec)
            ...
            @return_types    = typelib_types_for(runkit_return_typenames)
            @arguments_types = typelib_types_for(runkit_arguments_typenames)
        end
        ...
        def sendop(*args)
            common_call(args) do |filtered|
                handle = task.do_operation_send(name, runkit_arguments_typenames, filtered)
                handle.instance_variable_set :@operation, self
                handle.instance_variable_set :@runkit_return_types, @runkit_return_typenames.dup
