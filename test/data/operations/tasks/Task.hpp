...
#ifndef OPERATIONS_TASK_TASK_HPP
#define OPERATIONS_TASK_TASK_HPP

#include "operations/TaskBase.hpp"
...
namespace operations {
	...
	::Test::Opaque with_returned_opaque(::Test::Parameters const& b);
    ...
    public:
        Task(std::string const& name = "operations::Task", TaskCore::TaskState initial_state = Stopped);
