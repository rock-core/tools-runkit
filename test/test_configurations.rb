...
module Runkit
    describe TaskConfigurations do
        attr_reader :conf
        attr_reader :model

        before do
            @loader = OroGen::Loaders::RTT.new
            @model = @loader.task_model_from_name("orogen_runkit_tests::Configurations")
            @conf  = Runkit::TaskConfigurations.new(model)
            Runkit.load_typekit "orogen_runkit_tests"
        end
        ...
        it "should be able to load simple configuration structures" do
            ...
            verify_loaded_conf conf, "compound", "compound" do
                assert_conf_value "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :SECOND
        ...
        it "should be able to load complex structures" do
            ...
            verify_loaded_conf conf, "vector_of_compound", "compound", "vector_of_compound" do
                assert_conf_value 0, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :FIRST
                assert_conf_value 0, "intg", "/int32_t", Typelib::NumericType, 10
                assert_conf_value 1, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :SECOND
                assert_conf_value 1, "intg", "/int32_t", Typelib::NumericType, 20
                assert_conf_value 2, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :THIRD
            ...
            verify_loaded_conf conf, "vector_of_vector_of_compound", "compound", "vector_of_vector_of_compound" do
                assert_conf_value 0, 0, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :FIRST
                assert_conf_value 0, 0, "intg", "/int32_t", Typelib::NumericType, 10
                assert_conf_value 0, 1, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :SECOND
                assert_conf_value 0, 1, "intg", "/int32_t", Typelib::NumericType, 20
                assert_conf_value 0, 2, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :THIRD
                assert_conf_value 0, 2, "intg", "/int32_t", Typelib::NumericType, 30
                assert_conf_value 1, 0, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :FIRST
                assert_conf_value 1, 0, "intg", "/int32_t", Typelib::NumericType, 11
                assert_conf_value 1, 1, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :SECOND
                assert_conf_value 1, 1, "intg", "/int32_t", Typelib::NumericType, 21
                assert_conf_value 1, 2, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :THIRD
        ...
        describe "#conf" do
            it "merges configuration structures" do
                ...
                result = conf.conf(%w[default add], false)
                verify_loaded_conf result do
                    assert_conf_value "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :FIRST
                    assert_conf_value "intg", "/int32_t", Typelib::NumericType, 20
                end
                verify_loaded_conf result, "compound" do
                    assert_conf_value "compound", "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :THIRD
                    assert_conf_value "compound", "intg", "/int32_t", Typelib::NumericType, 30
                    assert_conf_value "vector_of_compound", 0, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :FIRST
                    assert_conf_value "vector_of_compound", 0, "intg", "/int32_t", Typelib::NumericType, 10
                    assert_conf_value "vector_of_compound", 1, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :SECOND
                    assert_conf_value "array_of_vector_of_compound", 0, 0, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :FIRST
                    assert_conf_value "array_of_vector_of_compound", 0, 0, "intg", "/int32_t", Typelib::NumericType, 10
                    assert_conf_value "array_of_vector_of_compound", 0, 1, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :SECOND
                    assert_conf_value "array_of_vector_of_compound", 0, 2, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :THIRD
                    assert_conf_value "array_of_vector_of_compound", 1, 0, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :FIRST
                    assert_conf_value "array_of_vector_of_compound", 1, 0, "intg", "/int32_t", Typelib::NumericType, 12
                    assert_conf_value "array_of_vector_of_compound", 2, 0, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :SECOND
                end
            end
            ...
            it "merge without overrides should have the same result than with if no conflicts exist" do
                conf.load_from_yaml(File.join(data_dir, "configurations", "merge.yml"))
                result = conf.conf(%w[default add], false)
                result_with_override = conf.conf(%w[default add], true)
            ...
            it "raises ArgumentError if conflicts exist and override is false" do
                ...
                conf.conf(%w[default override], true)
                assert_raises(ArgumentError) { conf.conf(%w[default override], false) }
            end
            ...
            it "accepts a 'default' section even if it does not exist" do
                assert_equal({}, conf.conf(["default"], false))
            end
            ...
            it "takes values from the last section if conflicts exist and override is true" do
                conf.load_from_yaml(File.join(data_dir, "configurations", "merge.yml"))
                result = conf.conf(%w[default override], true)
                ...
                verify_loaded_conf result, "compound" do
                    ...
                    assert_conf_value "vector_of_compound", 1, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :THIRD
        ...
        describe "#conf_as_ruby" do
            it "converts the configuration to a name-to-ruby value mapping" do
                conf.load_from_yaml(File.join(data_dir, "configurations", "merge.yml"))
                result = conf.conf_as_ruby(%w[default add], override: false)
        ...
        describe "#conf_as_typelib" do
            it "converts the configuration to a name-to-typelib value mapping" do
                conf.load_from_yaml(File.join(data_dir, "configurations", "merge.yml"))
                result = conf.conf_as_typelib(%w[default add], override: false)
                assert_equal "/orogen_runkit_tests/Enumeration", result["enm"].class.name
        ...
        it "should be able to apply simple configurations on the task" do
            ...
            task = start_and_get(
                { "orogen_runkit_tests::Configurations" => "conf" }, "conf"
            )
            ...
            conf.apply(task, %w[default compound])
            verify_applied_conf task do
                assert_conf_value "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :FIRST
                assert_conf_value "intg", "/int32_t", Typelib::NumericType, 20
                assert_conf_value "str", "/std/string", Typelib::ContainerType, "test"
            ...
            verify_applied_conf task, "compound" do
                ...
                assert_conf_value "str", "/std/string", Typelib::ContainerType, "test2"
                assert_conf_value "fp", "/double", Typelib::NumericType, 0.2
                assert_conf_value "simple_array", "/int32_t[10]", Typelib::ArrayType, simple_array, &:to_a
            end

            conf.apply(task, %w[default compound simple_container])
            simple_container = [10, 20, 30]
            verify_applied_conf task do
                assert_conf_value "simple_container", "/std/vector</int32_t>", Typelib::ContainerType, simple_container, &:to_a
            end
        end
        ...
        it "should be able to apply complex configuration on the task" do
            ...
            verify_apply_conf task, conf, "compound_in_compound", "compound", "compound" do
                assert_conf_value "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :THIRD
                assert_conf_value "intg", "/int32_t", Typelib::NumericType, 30
                assert_conf_value "str", "/std/string", Typelib::ContainerType, "test2"
                assert_conf_value "fp", "/double", Typelib::NumericType, 0.2
            end
        ...
        it "zeroes out newly created structures and initializes fields that need to" do
            ...
            verify_apply_conf task, conf, "zero_and_init", "compound", "vector_of_compound" do
                assert_conf_value 0, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :SECOND
                assert_conf_value 0, "intg", "/int32_t", Typelib::NumericType, 0
                assert_conf_value 1, "enm", "/orogen_runkit_tests/Enumeration", Typelib::EnumType, :FIRST
                assert_conf_value 1, "intg", "/int32_t", Typelib::NumericType, 20
            end
        end
        ...
        it "should be able to load a configuration directory, register configurations on a per-model basis, and report what changed" do
            ...
            result = manager.conf["orogen_runkit_tests::Configurations"].conf(%w[default add], false)
            ...
            assert_equal({}, manager.load_dir(File.join(data_dir, "configurations", "dir")))
            assert_equal({ "orogen_runkit_tests::Configurations" => ["default"] }, manager.load_dir(File.join(data_dir, "configurations", "dir_changed")))
            result = manager.conf["orogen_runkit_tests::Configurations"].conf(%w[default add], false)
        ...
        describe "#add" do
            before do
                manager = Runkit::ConfigurationManager.new
                manager.load_dir(File.join(data_dir, "configurations", "dir"))
                @conf = manager.conf["orogen_runkit_tests::Configurations"]
            end
        ...
        describe "#load_dir" do
            ...
            it "should return a hash from model name to section list if some sections got added or modified" do
                ...
                # Should not raise
                assert_equal Hash["task::Model" => %w[section other_section]], conf.load_dir("/conf")
            end
        end
        ...
        describe "#load_file" do
            ...
            before do
                FakeFS.activate!
                FileUtils.mkdir_p "/conf"
                # !!! Need to use the test-global loader with the task model already
                # pre-loaded. Loading won't work with FakeFS enabled
                @conf = flexmock(Runkit::ConfigurationManager.new(@loader))
            end
            after do
                FakeFS.deactivate!
                FakeFS::FileSystem.clear
            ...
            it "should allow to specify the model name manually" do
                File.open("/conf/first.yml", "w").close
                conf.load_file "/conf/first.yml", "orogen_runkit_tests::Configurations"
                flexmock(Runkit).should_receive(:task_model_from_name).with("task::Model")
                                .pass_thru
            end
            it "should infer the model name if it is not given" do
                File.open("/conf/orogen_runkit_tests::Configurations.yml", "w").close
                conf.load_file "/conf/orogen_runkit_tests::Configurations.yml"
                flexmock(Runkit).should_receive(:task_model_from_name).with("task::Model")
                                .pass_thru
            end
            ...
            it "should return false if no sections got added or modified" do
                File.open("/conf/orogen_runkit_tests::Configurations.yml", "w").close
                conf.load_file "/conf/orogen_runkit_tests::Configurations.yml"
                assert !conf.load_file("/conf/orogen_runkit_tests::Configurations.yml")
            end
            it "should return a hash from model name to section list if some sections got added or modified" do
                File.open("/conf/file.yml", "w") do |io|
                    io.puts "--- name:test"
                end
                assert_equal Hash["orogen_runkit_tests::Configurations" => ["test"]],
                             conf.load_file("/conf/file.yml", "orogen_runkit_tests::Configurations")
            end
        end
        ...
        describe ".save" do
            describe ".save(task)" do
                ...
                before do
                    @task = start_and_get(
                        { "orogen_runkit_tests::Configurations" => "task" },
                        "task"
                    )
                    # We must load all properties before we activate FakeFS
                    task.each_property do |p|
            ...
            describe ".save(config)" do
                ...
                it "saves the task's configuration file into the specified file and section" do
                    ...
                    assert_equal :FIRST, Typelib.to_ruby(c["enm"])
                end
        ...
        it "overrides arrays" do
            ...
            result = conf.conf(%w[default default], true)
            assert_equal(default_conf, hash_to_ruby(result))

            result = conf.conf(%w[default mti_xsens], true)
            assert_equal({ "gyrorrw" => default_conf["gyrorrw"],
                           "gyrorw" => xsens_conf["gyrorw"] }, hash_to_ruby(result))
        end

        def verify_loaded_conf(conf, name = nil, *base_path)
            if conf.respond_to?(:sections)
                assert conf.sections.key?(name)
                @conf_context = conf.sections[name]
            else
                @conf_context = conf
                base_path.unshift name if name
            end
